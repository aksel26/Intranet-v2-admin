...
export const VACATION_TABLE_HEADER = ["", "No", "소속", "팀명", "직급", "성명", "이메일", "총 연차일", "잔여 연차일", "최근 사용일"];

export const MEAL_SETTLEMENT_HEADER = ["", "No.", "직급", "성명", "총 금액", "사용 금액", "잔액", "정산금", "정산여부", "비고"];
export const MEAL_EXPENSES_HEADER = ["No", "직급", "성명", "유형", "사용처", "사용 금액", "작성일"];
...
export const VACATION_DETAIL_HEADER = ["회계연도", "사용일자", "승인자", "승인여부", "분류", "내용", "차감갯수", "잔여갯수", "수정일", "등록일", "승인일", ""];
